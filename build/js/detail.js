...
},{"./util":"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/util.js","marked":"/Users/jianhuang/Documents/dev/react-issue-viewer-local/node_modules/marked/lib/marked.js"}],"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/DetailViewer.js":[function(require,module,exports){
var //React = require('react'),
  //$ = require('jquery'),
  Comment = require('./Comment'),
  util = require('./util');

var DetailViewer = React.createClass({displayName: "DetailViewer",
  ...
  render: function() {
    var comments = this.state.comments.map(function(comment, idx) {
      return React.createElement(Comment, {data: comment, key: idx});
    });
    renderer = (
      React.createElement("div", {className: "detail-viewer"}, 
          React.createElement(Comment, {data: this.props.data}), 
          comments
      )
    );
    return renderer;
...
},{"./Comment":"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/Comment.js","./util":"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/util.js"}],"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/detail.js":[function(require,module,exports){
var //React = require('react'), //react lib is included in the html page
  DetailViewer = require('./DetailViewer.js'),
  //$ = require('jquery'), // jquery is included in the html
  util = require('./util');
...
$.get(util.getIssueUrl(number), function(data) {
  var labels = data.labels.map(function(label) {
    return (
      React.createElement("a", {className: "label-link", href: util.baseUrl + 'labels/' + label.name}, 
          React.createElement("span", {className: "label issue-label", style: {backgroundColor: '#' + label.color}}, label.name)
        )
    );
  });
  ...
  React.render(
    React.createElement("div", null, 
      React.createElement("span", {className: 'label issue-state ' + stateClass}, data.state), 
    React.createElement("span", {className: "issue-title"}, data.title), 
        labels
      ), document.getElementsByClassName('title-container')[0]);
  React.render(React.createElement(DetailViewer, {data: data}), document.getElementById('container'));
});

},{"./DetailViewer.js":"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/DetailViewer.js","./util":"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/util.js"}],"/Users/jianhuang/Documents/dev/react-issue-viewer-local/src/js/util.js":[function(require,module,exports){
//var $ = require('jquery');
